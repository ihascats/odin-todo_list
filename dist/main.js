...
/***/ "./src/js/tasksWithinProject.js":
/*!**************************************!*\
  !*** ./src/js/tasksWithinProject.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _newProjectButton__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newProjectButton */ \"./src/js/newProjectButton.js\");\n\nfunction showTasksToUser(selected, info, appendTo){\n    if (!info.returnTasksWithin(selected.textContent)) return\n    info.returnTasksWithin(selected.textContent).forEach(position => {\n        let item = info.toDoItemArray[position];\n        let title = item.title;\n        let id = item.id;\n        if (id == 0){\n            appendTo.appendChild((0,_newProjectButton__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(title, '0'));\n        } else\n        appendTo.appendChild((0,_newProjectButton__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(title, id));\n    });\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (showTasksToUser);\n\n//# sourceURL=webpack://odin-todo_list/./src/js/tasksWithinProject.js?");
